...
public class UserDb {
	...
	public void insertUser(RegisterBean rb) {
		...
		try {
			...
			stmt.executeUpdate("insert into atm.register(accountNumber,pin,confirmPin,userName,education,occupation,PhoneNo) values ('"+rb.getAccountNumber()+"','"+rb.getPin()+"','"+rb.getConfirmPin()+"','"+rb.getName()+"','"+rb.getEducation()+"','"+rb.getOccupation()+"','"+rb.getPhone()+"')");
